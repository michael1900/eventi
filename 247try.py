...
M3U8_OUTPUT_FILE = "247try.m3u8"
EPG_OUTPUT_FILE = "247try.xml"
...
def generate_m3u8_247(matches): # Rinominata per evitare conflitti
    ...
    with open(M3U8_OUTPUT_FILE, 'w', encoding='utf-8') as file:
        # Aggiungi l'intestazione #EXTM3U
        file.write("#EXTM3U\n\n")
        ...
        for channel in matches:
            ...
            if stream_url_dynamic:
                ...
                file.write(f'#EXTVLCOPT:http-referrer=https://newembedplay.xyz/premiumtv/daddyhd.php?id={channel_id}\n')
